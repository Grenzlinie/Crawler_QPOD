# QPOD 数据库下载指南 (Download Guide for QPOD Database)
...
本仓库提供了一套 Python 工具，帮助你从 !Quantum Point Defects Database (QPOD) 网站批量获取材料 ID，并下载对应的 CIF 文件。以下内容介绍了环境准备、依赖安装以及各脚本的推荐使用顺序。

This repository provides a set of Python tools to help you batch retrieve material IDs from the QPOD website and download the corresponding CIF files. The following content describes environment setup, dependency installation, and the recommended order for using each script.
